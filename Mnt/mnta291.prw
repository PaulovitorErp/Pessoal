...
Static Function fLoadTRB(nOpcao, cFiltro, cCodFun, cEquipe, cFornec)
	...
	If nOpcao == __OPC_TQB__ .or. nOpcao == __OPC_TQB2__
		...
		cQueryCmp += 'ST9.T9_NOME AS TQB_NOMBEM, '
		...
		If !Empty(cCodFun)
			If __nAtEq291 == 0 .Or. __nAtEq291 == 1
				...
				cQuery += 'TUR.TUR_CODATE = ' + ValToSQL(cCodFun) +') '
...
Function MNT291OS(cFilSS, cCodSS, lVisual)
	...
	aAdd(aRotina, {STR0006 , "NGIMP675(STJ->TJ_ORDEM,STJ->TJ_PLANO,.f.,STJ->TJ_FILIAL,STJ->(RECNO()))"  ,0, 4}) //"Imprimir"
	...
	cQueryIns += 'TJ_APROPRI, TJ_AS, TJ_PROJETO, TJ_OBRA, TBLORI ) '
	...
	cQuery += "STJ.TJ_APROPRI, STJ.TJ_AS, STJ.TJ_PROJETO, STJ.TJ_OBRA, 'STJ' AS TBLORI "
	...
	cQuery += "STS.TS_APROPRI, STS.TS_AS, STS.TS_PROJETO, STS.TS_OBRA, 'STS' AS TBLORI "
