...
User function RCOMA006()
	...
	//legendas
	oBrowse:AddLegend( "ZB1_CODIGO=='003'", "GREEN" , "Codigo 003" )
	oBrowse:AddLegend( "ZB1_CODIGO<>'003'", "YELLOW", "Codigo Diferente de 003" )
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE 'Visualizar'      ACTION 'VIEWDEF.RCOMA006' OPERATION 2 ACCESS 0
	//ADD OPTION aRotina TITLE 'Incluir'         ACTION 'VIEWDEF.RCOMA006' OPERATION 3 ACCESS 0
	//ADD OPTION aRotina TITLE 'Excluir'         ACTION 'VIEWDEF.RCOMA006' OPERATION 5 ACCESS 0
	ADD OPTION aRotina TITLE 'Matricular'      ACTION 'VIEWDEF.RCOMA006' OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE 'Copiar'          ACTION 'VIEWDEF.RCOMA006' OPERATION 9 ACCESS 0
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New('PCOMA006', /*bPreValidacao*/, /*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
...
Static Function ViewDef()
	...
	Local oModel   := FWLoadModel( 'RCOMA006' )
	Local oView
	...
	oView:AddSheet('PASTAS', 'ABA01', 'Alunos')
	oView:AddSheet('PASTAS', 'ABA02', 'Disciplinas')
	
	// Quebra em 2 "box" vertical para receber algum elemento da view 
	oView:CreateHorizontalBox( 'INFERIOR1', 100,,,'PASTAS', 'ABA01')
	oView:CreateHorizontalBox( 'INFERIOR2', 100,,,'PASTAS', 'ABA02')
	
	
	// Relaciona o identificador (ID) da View com o "box" para exibição
	oView:SetOwnerView( 'VIEW_ZB1', 'SUPERIOR' )
	oView:SetOwnerView( 'VIEW_ZB6', 'INFERIOR1' )
	oView:SetOwnerView( 'VIEW_ZB7', 'INFERIOR2' )
