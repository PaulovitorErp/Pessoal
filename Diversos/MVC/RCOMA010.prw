...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE 'Visualizar'      ACTION 'VIEWDEF.RCOMA010' OPERATION 2 ACCESS 0
	ADD OPTION aRotina TITLE 'Incluir'         ACTION 'VIEWDEF.RCOMA010' OPERATION 3 ACCESS 0
	ADD OPTION aRotina TITLE 'Excluir'         ACTION 'VIEWDEF.RCOMA010' OPERATION 5 ACCESS 0
	ADD OPTION aRotina TITLE 'Alterar'      ACTION 'VIEWDEF.RCOMA010' OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE 'Copiar'          ACTION 'VIEWDEF.RCOMA010' OPERATION 9 ACCESS 0
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New('PCOMA010', /*bPreValidacao*/, /*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
