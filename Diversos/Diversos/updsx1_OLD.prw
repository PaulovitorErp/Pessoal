...
/*/
//--------------------------------------------------------------------
User Function UPDSX1( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPDSX1" )
				Else
					MsgStop( "Atualização não realizada.", "UPDSX1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Desc.Prc.Neg'															, ; //X3_TITULO
	'Desc.Prc.Neg'															, ; //X3_TITSPA
	'Desc.Prc.Neg'															, ; //X3_TITENG
	'Desconto s/ Preco Neg?'												, ; //X3_DESCRIC
	'Desconto s/ Preco Neg?'												, ; //X3_DESCSPA
	'Desconto s/ Preco Neg?'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Vend.Cli.Blq'															, ; //X3_TITULO
	'Vend.Cli.Blq'															, ; //X3_TITSPA
	'Vend.Cli.Blq'															, ; //X3_TITENG
	'Venda Cliente Bloqueado?'												, ; //X3_DESCRIC
	'Venda Cliente Bloqueado?'												, ; //X3_DESCSPA
	'Venda Cliente Bloqueado?'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vlr. Sem Lim'															, ; //X3_TITULO
	'Vlr. Sem Lim'															, ; //X3_TITSPA
	'Vlr. Sem Lim'															, ; //X3_TITENG
	'Vlr Venda Cli. sem Limite'												, ; //X3_DESCRIC
	'Vlr Venda Cli. sem Limite'												, ; //X3_DESCSPA
	'Vlr Venda Cli. sem Limite'												, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	'% sem Lim.'															, ; //X3_TITSPA
	'% sem Lim.'															, ; //X3_TITENG
	'% Venda Cli. sem Limite'												, ; //X3_DESCRIC
	'% Venda Cli. sem Limite'												, ; //X3_DESCSPA
	'% Venda Cli. sem Limite'												, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vlr.Max.Comp'															, ; //X3_TITULO
	'Vlr.Max.Comp'															, ; //X3_TITSPA
	'Vlr.Max.Comp'															, ; //X3_TITENG
	'Valor Maximo a Compensar'												, ; //X3_DESCRIC
	'Valor Maximo a Compensar'												, ; //X3_DESCSPA
	'Valor Maximo a Compensar'												, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vlr.Sq.s/Lim'															, ; //X3_TITULO
	'Vlr.Sq.s/Lim'															, ; //X3_TITSPA
	'Vlr.Sq.s/Lim'															, ; //X3_TITENG
	'Valor Saque Sem Limite'												, ; //X3_DESCRIC
	'Valor Saque Sem Limite'												, ; //X3_DESCSPA
	'Valor Saque Sem Limite'												, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'% Sq.s/ Lim'															, ; //X3_TITSPA
	'% Sq.s/ Lim'															, ; //X3_TITENG
	'% Saque sem Limite'													, ; //X3_DESCRIC
	'% Saque sem Limite'													, ; //X3_DESCSPA
	'% Saque sem Limite'													, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Saq.Cli.Blq'															, ; //X3_TITULO
	'Saq.Cli.Blq'															, ; //X3_TITSPA
	'Saq.Cli.Blq'															, ; //X3_TITENG
	'Saque Cliente Bloqueado?'												, ; //X3_DESCRIC
	'Saque Cliente Bloqueado?'												, ; //X3_DESCSPA
	'Saque Cliente Bloqueado?'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vlr.Falta Cx'															, ; //X3_TITULO
	'Vlr.Falta Cx'															, ; //X3_TITSPA
	'Vlr.Falta Cx'															, ; //X3_TITENG
	'Vlr. Falta Caixa p/ Posto'												, ; //X3_DESCRIC
	'Vlr. Falta Caixa p/ Posto'												, ; //X3_DESCSPA
	'Vlr. Falta Caixa p/ Posto'												, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'% Desc.Tit.'															, ; //X3_TITSPA
	'% Desc.Tit.'															, ; //X3_TITENG
	'% Maximo desconto Titulo'												, ; //X3_DESCRIC
	'% Maximo desconto Titulo'												, ; //X3_DESCSPA
	'% Maximo desconto Titulo'												, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vl.Max.Troco'															, ; //X3_TITULO
	'Vl.Max.Troco'															, ; //X3_TITSPA
	'Vl.Max.Troco'															, ; //X3_TITENG
	'Valor Maximo Troco'													, ; //X3_DESCRIC
	'Valor Maximo Troco'													, ; //X3_DESCSPA
	'Valor Maximo Troco'													, ; //X3_DESCENG
	'@E 999,999,999.99'														, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'% Max Troco'															, ; //X3_TITSPA
	'% Max Troco'															, ; //X3_TITENG
	'% Maximo de Troco'														, ; //X3_DESCRIC
	'% Maximo de Troco'														, ; //X3_DESCSPA
	'% Maximo de Troco'														, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSX1" ) ) ) ;
