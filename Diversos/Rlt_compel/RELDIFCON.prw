...
SELECT 
D1_FILIAL,D1_DOC,D1_SERIE,A2_COD,A2_LOJA,A2_NOME,D1_EMISSAO,D1_DTDIGIT,F4_CODIGO,F4_SITTRIB,F4_TEXTO,SD1.R_E_C_N_O_ AS RECSD1,CV3_RECORI AS RECORICV3,CV3_RECDES AS RECDESCV3,CT2.R_E_C_N_O_ AS RECCT2,CV3_LP,CV3_LPSEQ,CT2_DEBITO,CT2_CREDIT,CT2_VALOR
FROM 
SD1010 SD1
