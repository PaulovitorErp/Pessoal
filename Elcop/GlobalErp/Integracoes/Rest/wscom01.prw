...
WSMETHOD POST CriarPedido WSSERVICE PedidoCompras
    ...
    IF !Empty(cError)
        ...
        lRet    := .F.
    Else
        //Lendo o cabe�alho do arquivo JSON
        ...
        //Verifica se a condi��o de pagamento existe			    
     ...
     */
        ...
        IF ValType( oItems ) == "A"
            ...
            //Monta o cabe�alho do pedido de compras apenas se houver itens
...
//Fun��o para consulta simples se um registro existe
