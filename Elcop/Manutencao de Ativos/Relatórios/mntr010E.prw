...
static Function RFR010Imp(lEND,WNREL,TITULO,TAMANHO)
    ...
    CABEC1 := "Bem       Placa    Veiculo                             Descrição Manutençao                Dt.Ult.Man. Dt.Próx.Man Ord Serv  Contador Dt.Contad. Var.Di KM Prev. Dias Cent Custo Familia"
    CABEC2 := " "                                                                                                                                                                    
    ...
    *************************************************************************************************************************************
Bem       Placa    Descrição                                Descrição                      Dt.Ult.Man. Dt.Próx.Man Ord Serv Contador Dt.Contad. Var.Di KM Prev. Dias Cent Custo
...
xxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxxcxxxxxxxxxxxxxxxxxxxxxxx  99/99/9999 99/99/9999   xxxxxx   999.999 12/12/1234  9999  999.999  9999
    ...
    */
    ...
    Else
        MsgInfo("Não Existe OS Preventivas da Exibir", "OK")
        Return .F.
    EndIf
