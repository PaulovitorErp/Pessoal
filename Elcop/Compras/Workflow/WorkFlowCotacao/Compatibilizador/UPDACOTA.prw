...
/*/
//--------------------------------------------------------------------
User Function UPDACOTA( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualiza��o dos dicion�rios ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualiza��o Realizada.", "UPDAPROV" )
				Else
					MsgStop( "Atualiza��o n�o Realizada.", "UPDAPROV" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
Local cMsg      := ""
Local cSeqAtu   := ""
Local cUsado	:= "x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x     "
Local cReserv	:= "xxxxxx x        "
Local cX3Campo  := ""
Local cX3Dado   := ""
Local lTodosNao := .F.
Local lTodosSim := .F.
...
aAdd( aSX3, { ;
	...
	'E-mail WF'																, ; //X3_TITSPA
	'E-mail WF'																, ; //X3_TITENG
	'E-mail WF'																, ; //X3_DESCRIC
	'E-mail WF'																, ; //X3_DESCSPA
	'E-mail WF'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	cUsado																	, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Moeda Cota��o'															, ; //X3_TITULO
	'Moeda Cota��o'															, ; //X3_TITSPA
	'Moeda Cota��o'															, ; //X3_TITENG
	'Moeda Cota��o'															, ; //X3_DESCRIC
	'Moeda Cota��o'															, ; //X3_DESCSPA
	'Moeda Cota��o'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	cUsado																	, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX6, { ;
	...
	'MV_XWFCMP'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'E-mail do comprador'													, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'E-mail do comprador'													, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'E-mail do comprador'													, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	''																		, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
...
aAdd( aSX6, { ;
	...
	'MV_XWFDIAS'																, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Numero de dias do e-mail inicial ter sido enviado'						, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'e o mesmo nao terem sido respondidos'									, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'Usado para desconsiderar o WORKFLOW.'									, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'10'																	, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
...
aAdd( aSX6, { ;
	...
	'MV_XWFHORA'															, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Numero de horas do e-mail inicial ter sido enviado'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'e o mesmo nao terem sido respondidos'									, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
...
aAdd( aSX6, { ;
	...
	'MV_XWFWS'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Endereco do WebService'												, ; //X6_DESCRIC
	'Endereco do WebService'												, ; //X6_DSCSPA
	'Endereco do WebService'												, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
aAdd( aSX6, { ;
	...
	'MV_XMSAPRO'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Parametro para apresentacao de mensagem informativ'					, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'informativa de Envio de E-mail'										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
